...
setmetatable(const, {
    __index = function (t, k)
        return function()
            print("unknown field from const: ", k)
        end
    end
    })
...
---! const values
const.LANDLORD_MAX_CARD_VALUE        = 54
const.LANDLORD_CARD_BACKGROUND       = 55
const.LANDLORD_PLAYER_CARD_NUM       = 17
const.LANDLORD_LORD_CARD_NUM         = 20
const.LANDLORD_BOTTOM_CARD_NUM       = 3
const.LANDLORD_MAX_PLAYER_NUM        = 3
...
---! game trace
const.LANDLORD_GAMETRACE_PICKUP          = 1    -- 发牌
const.LANDLORD_GAMETRACE_DISCLOSE        = 2    -- 明牌
const.LANDLORD_GAMETRACE_REFRESH         = 3    -- 更新牌面
const.LANDLORD_GAMETRACE_LANDLORD        = 4    -- 叫地主
const.LANDLORD_GAMETRACE_MULTIPLE        = 5    -- 加倍
const.LANDLORD_GAMETRACE_THROW           = 6    -- 出牌
const.LANDLORD_GAMETRACE_SHOWBOTTOM      = 7    -- 显示底牌
const.LANDLORD_GAMETRACE_BOMBMULT        = 8    -- 炸弹, 更新倍数
const.LANDLORD_GAMETRACE_GAMEOVER        = 10


---! table status
const.LANDLORD_TABLE_STATUS_WAIT_NEWGAME      = 5
const.LANDLORD_TABLE_STATUS_WAIT_PICKUP       = 6       -- 发牌
const.LANDLORD_TABLE_STATUS_WAIT_LANDLORD     = 7       -- 叫地主
const.LANDLORD_TABLE_STATUS_WAIT_MULTIPLE     = 8       -- 加倍
const.LANDLORD_TABLE_STATUS_WAIT_THROW        = 9
const.LANDLORD_TABLE_STATUS_WAIT_GAMEOVER     = 10

---! time out
const.LANDLORD_TIMEOUT_WAIT_PICKUP       = 5
const.LANDLORD_TIMEOUT_WAIT_LANDLORD     = 10
const.LANDLORD_TIMEOUT_WAIT_MULTIPLE     = 10
const.LANDLORD_TIMEOUT_WAIT_THROW        = 25
const.LANDLORD_TIMEOUT_WAIT_OFFLINE      = 5
const.LANDLORD_TIMEOUT_WAIT_GAMEOVER     = 2
const.LANDLORD_TIMEOUT_WAIT_NEWGAME      = 3
...
const.LANDLORD_ACL_STATUS_RESTART_NO_MASTER                     =   101;  -- 没有人叫地主， 重新开始

const.LANDLORD_ACL_STATUS_NO_SELECT_CARDS                       =   102;  -- 你没有选择任何牌

const.LANDLORD_ACL_STATUS_NOT_VALID_TYPE                        =   103;  -- 不能组成有效牌型
const.LANDLORD_ACL_STATUS_NOT_SAME_TYPE                         =   104;  -- 不是同一牌型
const.LANDLORD_ACL_STATUS_NOT_BIGGER                            =   105;  -- 打不过别人的牌
const.LANDLORD_ACL_STATUS_NO_BIG_CARDS                          =   106;  -- 没有牌能大过上家
const.LANDLORD_ACL_STATUS_NO_YOUR_CARDS                         =   107;  -- 发的牌不是你的牌
